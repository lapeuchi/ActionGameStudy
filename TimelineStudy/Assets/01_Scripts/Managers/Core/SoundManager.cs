...
public class SoundManager
{
    ...
    public void Play(string path, Define.Sound type = Define.Sound.SFX, float pitch = 1.0f, bool loop = false)
    {
    ...
    public void Play(AudioClip audioClip, Define.Sound type = Define.Sound.SFX, float pitch = 1.0f, bool loop = false)
    {
        if (audioClip == null)
            return;
